...
def read():
    ...
    """
    docs = db.exampleapp.find({}).sort("spending_date", -1) # sort in descending order of spending date as timestamp
    return render_template('read.html', docs=docs) # render the read template

@app.route('/read', methods=['POST'])
def read_old_first():
    docs = db.exampleapp.find({}).sort("spending_date",1) # sort in desceding order of spending date
    return render_template('read.html', docs=docs) # render the read template
...
#     Displays some information for the user with links to other pages.
#     """
#     docs = db.exampleapp.find({}).sort("price", 1) # sort in ascending order of unit price
#     return render_template('read.html', docs=docs) # render the read template  
...
def create_post():
    ...
    spending_date = request.form['fdate']
